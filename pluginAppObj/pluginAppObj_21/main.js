...
function hoverimage_pluginAppObj_21() {
    
    x5engine.boot.push(function(){
        var container = $("#pluginAppObj_21 .container");
        ...
        if (x5engine != null && !x5engine.responsive.isMobileDevice()) {
            ...
            var figure = document.getElementById("pluginAppObj_21-figure");
            var superContainer = document.getElementById("pluginAppObj_21");
        ...
        if ( 1 == 2 ||  1 == 7 ) {
            $("#pluginAppObj_21").css("z-index", "2000");
        }
