...
function hoverimage_pluginAppObj_23() {
    
    x5engine.boot.push(function(){
        var container = $("#pluginAppObj_23 .container");
        ...
        if (x5engine != null && !x5engine.responsive.isMobileDevice()) {
            ...
            var figure = document.getElementById("pluginAppObj_23-figure");
            var superContainer = document.getElementById("pluginAppObj_23");
        ...
        if ( 1 == 2 ||  1 == 7 ) {
            $("#pluginAppObj_23").css("z-index", "2000");
        }
