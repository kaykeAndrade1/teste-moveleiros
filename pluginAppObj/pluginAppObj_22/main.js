...
function hoverimage_pluginAppObj_22() {
    
    x5engine.boot.push(function(){
        var container = $("#pluginAppObj_22 .container");
        ...
        if (x5engine != null && !x5engine.responsive.isMobileDevice()) {
            ...
            var figure = document.getElementById("pluginAppObj_22-figure");
            var superContainer = document.getElementById("pluginAppObj_22");
        ...
        if ( 1 == 2 ||  1 == 7 ) {
            $("#pluginAppObj_22").css("z-index", "2000");
        }
